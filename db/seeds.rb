...
twelve = Product.create(title: "Twelve", 
	subtitle: "Learn Music", author: "Dan Kreiger", 
	length: "Yearly", author_image_name: "head_shot_small_res.jpg", 
	price: "9.99", sku: "TWEL1", download_url: "https://s3.amazonaws.com/fourthree/Piano.jpg", details: "12-month subscription with full access to learning material",
...
twelve_in_twelve = Product.create(title: "Twelve in Twelve", 
  ...
  price: "9.99", sku: "TWEL3", download_url: "https://s3.amazonaws.com/fourthree/Piano.jpg", details: "Monthly subscription with full access to learning material",
  description: %{<p>If you want to play piano well, you just need to focus on one thing: <a href="http://en.wikipedia.org/wiki/Scale_(music)">scales</a>. </p><p>We hope to help make scales fun, simple, and accessible here.</p><p>Charlie Parker once said: "I realized by using the high notes of the chords as a melodic line, and by the right harmonic progression, I could play what I heard inside me. That's when I was born."</p><p>When you practice scales, you are learning the language of music - If you practice them, you'll find yourself speaking and breathing music. Just do it and you'll see.</p>
  <p><strong>What You'll Learn</strong></p>
  <ul class="no-indent">
      <li>What is the Circle of 5ths?</li>
...
# twelve_in_twelve = Product.create(title: "Twelve in Twelve", subtitle: "Learn Music", author: "Dan Kreiger", price: "9.99", sku: "TWEL3", details: "Monthly access to learning material", description: %{ <p>If you want to play piano well, you just need to focus on one thing: <a href="http://en.wikipedia.org/wiki/Scale_(music)">scales</a>. </p><p>We hope to help make scales fun, simple, and accessible here.</p><p>Charlie Parker once said: "I realized by using the high notes of the chords as a melodic line, and by the right harmonic progression, I could play what I heard inside me. That's when I was born."</p><p>When you practice scales, you are learning the language of music - If you practice them, you'll find yourself speaking and breathing music. Just do it and you'll see.</p>
#   <p><strong>What You'll Learn</strong></p>
#   <ul class="no-indent">
#       <li>What is the Circle of 5ths?</li>
#       <li>The major scale pattern</li>
